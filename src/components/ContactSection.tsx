      ...
      <div className="container-padding max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Tem alguma dúvida? Nossa equipe está pronta para ajudar você a transformar sua estratégia de captura de leads
          </p>
        </motion.div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 mt-1">contato@leadcapture.com.br</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 mt-1">Av. Paulista, 1000, São Paulo - SP</p>
                </div>
              </div>
            </div>
            
            <div className="mt-12">
              <h3 className="text-lg font-medium text-gray-900 mb-4">Siga-nos nas redes sociais</h3>
              <div className="flex space-x-4">
                <motion.a 
                  href="#" 
                  className="bg-gray-100 p-3 rounded-full text-gray-600 hover:text-blue-600 hover:bg-blue-50 transition-colors"
