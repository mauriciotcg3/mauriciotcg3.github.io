      ...
      <div className="container-padding max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="text-xl font-bold text-white mb-4">LeadCapture</div>
            <p className="text-gray-400 mb-4 max-w-md">
              Somos especialistas em estratégias de captura e nutrição de leads, ajudando empresas a aumentar suas taxas de conversão e potencializar suas vendas.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">contato@leadcapture.com.br</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-gray-400 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="border-t border-gray-800 mt-10 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} LeadCapture. Todos os direitos reservados.
            </p>
